...
object I18nKeys:
  ...
  val `welcomeToLichess` = I18nKey("welcomeToLichess")
  val `thisIsYourProfilePage` = I18nKey("thisIsYourProfilePage")
  val `wouldYouLikeToX` = I18nKey("wouldYouLikeToX")
  val `improveIt` = I18nKey("improveIt")
  val `enabledKidModeSuggestion` = I18nKey("enabledKidModeSuggestion")
  val `whatNowSuggestions` = I18nKey("whatNowSuggestions")
  val `learnChessRules` = I18nKey("learnChessRules")
  ...
  val `playAndCreateTournaments` = I18nKey("playAndCreateTournaments")
  val `playAndCreateSimul` = I18nKey("playAndCreateSimul")
  val `standardAndEightVariants` = I18nKey("standardAndEightVariants")
  val `deepEngineServerAnalysis` = I18nKey("deepEngineServerAnalysis")
  val `boardEditorAndAnalysisBoardWithSF` = I18nKey("boardEditorAndAnalysisBoardWithSF")
  val `cloudEngineAnalysis` = I18nKey("cloudEngineAnalysis")
  val `studiesSharedAndPersistentAnalysis` = I18nKey("studiesSharedAndPersistentAnalysis")
  val `chessInsightsDetailedAnalysisOfYourPlay` = I18nKey("chessInsightsDetailedAnalysisOfYourPlay")
  val `allChessBasicsLessons` = I18nKey("allChessBasicsLessons")
  val `tacticalPuzzlesFromUserGames` = I18nKey("tacticalPuzzlesFromUserGames")
  val `globalOpeningExplorer0` = I18nKey("globalOpeningExplorer0")
  val `globalOpeningExplorer` = I18nKey("globalOpeningExplorer")
  val `personalOpeningExplorer0` = I18nKey("personalOpeningExplorer0")
  val `personalOpeningExplorer` = I18nKey("personalOpeningExplorer")
  val `otherPlayers` = I18nKey("otherPlayers")
  val `sevenPieceEndgameTablebase` = I18nKey("sevenPieceEndgameTablebase")
  val `downloadOrUploadAnyGameAsPgn` = I18nKey("downloadOrUploadAnyGameAsPgn")
  val `advancedSearchThroughOverNbLichessGames` = I18nKey("advancedSearchThroughOverNbLichessGames")
  val `forumTeamsMessagingFriendsChallenges` = I18nKey("forumTeamsMessagingFriendsChallenges")
  val `availableInNbLanguage` = I18nKey("availableInNbLanguage")
  val `nbLanguages` = I18nKey("nbLanguages")
  val `themeBoardsPiecesBackground` = I18nKey("themeBoardsPiecesBackground")
  val `allFeaturesToComeForever` = I18nKey("allFeaturesToComeForever")
  val `xLandscapeSupport` = I18nKey("xLandscapeSupport")
  val `supportLichess` = I18nKey("supportLichess")
  val `contributeToLichessAndX` = I18nKey("contributeToLichessAndX")
  val `yesBothAccountsHaveTheSameFeatures` = I18nKey("yesBothAccountsHaveTheSameFeatures")
  val `reasonFreeAndPatronAccountSame` = I18nKey("reasonFreeAndPatronAccountSame")
  val `allFeaturesAreFree` = I18nKey("allFeaturesAreFree")
  val `ifYouLoveLichess` = I18nKey("ifYouLoveLichess")
  ...
  object faq:
    ...
    val `enableAutoplayForSounds1` = I18nKey("faq:enableAutoplayForSounds1")
    val `enableAutoplayForSounds2` = I18nKey("faq:enableAutoplayForSounds2")
    val `enableAutoplayForSounds3` = I18nKey("faq:enableAutoplayForSounds3")
    val `goToLichess` = I18nKey("faq:goToLichess")
    val `browsersMozillaFirefox` = I18nKey("faq:browsersMozillaFirefox")
    val `browsersMozillaFirefox1` = I18nKey("faq:browsersMozillaFirefox1")
    val `browsersMozillaFirefox2` = I18nKey("faq:browsersMozillaFirefox2")
    val `browsersMozillaFirefox3` = I18nKey("faq:browsersMozillaFirefox3")
    val `browsersGoogleChrome` = I18nKey("faq:browsersGoogleChrome")
    val `browsersGoogleChrome1` = I18nKey("faq:browsersGoogleChrome1")
    val `browsersGoogleChrome2` = I18nKey("faq:browsersGoogleChrome2")
    val `browsersGoogleChrome3` = I18nKey("faq:browsersGoogleChrome3")
    val `browsersSafari` = I18nKey("faq:browsersSafari")
    val `browsersSafari1` = I18nKey("faq:browsersSafari1")
    val `browsersSafari2` = I18nKey("faq:browsersSafari2")
    val `browsersSafari3` = I18nKey("faq:browsersSafari3")
    val `browsersMicrosoftEdge` = I18nKey("faq:browsersMicrosoftEdge")
    val `browsersMicrosoftEdge1` = I18nKey("faq:browsersMicrosoftEdge1")
    val `browsersMicrosoftEdge2` = I18nKey("faq:browsersMicrosoftEdge2")
    val `browsersMicrosoftEdge3` = I18nKey("faq:browsersMicrosoftEdge3")
    val `browsersMicrosoftEdge4` = I18nKey("faq:browsersMicrosoftEdge4")
    val `browsersMicrosoftEdge5` = I18nKey("faq:browsersMicrosoftEdge5")
