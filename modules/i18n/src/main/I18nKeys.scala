...
object I18nKeys:
  ...
  val `grandmaster` = I18nKey("grandmaster")
  val `womanGrandmaster` = I18nKey("womanGrandmaster")
  val `internationalMaster` = I18nKey("internationalMaster")
  val `womanInternationalMaster` = I18nKey("womanInternationalMaster")
  val `fideMaster` = I18nKey("fideMaster")
  val `womanFideMaster` = I18nKey("womanFideMaster")
  val `candidateMaster` = I18nKey("candidateMaster")
  val `womanCandidateMaster` = I18nKey("womanCandidateMaster")
  val `nationalMaster` = I18nKey("nationalMaster")
  val `womanNationalMaster` = I18nKey("womanNationalMaster")
  val `lichessMaster` = I18nKey("lichessMaster")
  val `chessRobot` = I18nKey("chessRobot")
  ...
  object broadcast:
    ...
    val `replace` = I18nKey("broadcast:replace")
    val `replaceHelp` = I18nKey("broadcast:replaceHelp")
